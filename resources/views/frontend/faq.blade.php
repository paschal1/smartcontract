                        ...
                        <div class="page-next">
                            <nav aria-label="breadcrumb" class="d-inline-block">
                                <ul class="mb-0 bg-white rounded shadow breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ url('index')}}">Securedgainers</a>
                                    </li>
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="pb-2 mb-4 text-center section-title">
                        ...
                        <p class="mx-auto para-desc text-muted">Launch your campaign and benefit from our expertise on designing and managing conversion centered bootstrap4 html page.</p>
                    </div>
                </div>
                <!--end col-->
            </div>
                    ...
                    <div class="text-center bg-white border-0 rounded card explore-feature">
                        <div class="card-body">
                            ...
                            <div class="mt-3 content">
                                <a href="{{ url('faq')}}" class="title h5 text-dark">FAQs</a>
                                <p class="mt-3 mb-0 text-muted">Due to its widespread use as filler text for layouts, non-readability is of great importance.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="pt-2 mt-4 col-lg-4 col-md-6 col-12">
                    <div class="text-center bg-white border-0 rounded card explore-feature">
                        <div class="card-body">
                            ...
                            <div class="mt-3 content">
                                <a href="{{ route('login')}}" class="title h5 text-dark">Guides / Support</a>
                                <p class="mt-3 mb-0 text-muted">Due to its widespread use as filler text for layouts, non-readability is of great importance.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="pt-2 mt-4 col-lg-4 col-md-6 col-12">
                    <div class="text-center bg-white border-0 rounded card explore-feature">
                        <div class="card-body">
                            ...
                            <div class="mt-3 content">
                                <a href="{{ url('contact')}}" class="title h5 text-dark">Support Request</a>
                                <p class="mt-3 mb-0 text-muted">Due to its widespread use as filler text for layouts, non-readability is of great importance.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="pt-2 mt-4 col-lg-9">
                    <div class="faq-content">
                        <div class="accordion" id="accordionExample">
                                ...
                                <a data-toggle="collapse" href="#collapse2" class="faq position-relative"
                                    aria-expanded="true" aria-controls="collapse2">
                                    <div class="p-3 border-0 shadow card-header bg-light" id="heading2">
                                        <h6 class="mb-0 title">How can i deposit money</h6>
                                    </div>
                                </a>
                                <div id="collapse2" class="collapse show" aria-labelledby="heading2"
                                    data-parent="#accordionExample">
                                    <div class="card-body">
                                        <p class="mb-0 text-muted faq-ans"> The deposit of course do not hinder </p>
                                    </div>
                                </div>
                            </div>
                                                        <div class="mb-2 border-0 rounded card">
