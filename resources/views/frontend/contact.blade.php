                        ...
                        <div class="page-next">
                            <nav aria-label="breadcrumb" class="d-inline-block">
                                <ul class="mb-0 bg-white rounded shadow breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">Securedgainers</a>
                                    </li>
                ...
                <div class="col-md-4">
                    <div class="text-center border-0 card features feature-clean">
                        ...
                        <div class="mt-3 content">
                            ...
                            <a href="tel: +1(903) 326-3407"
                                class="text-primary"> +1(903) 326-3407</a>
                        </div>
                    </div>
                </div>
                <!--end col-->
                    ...
                    <div class="text-center border-0 card features feature-clean">
                        ...
                        <div class="mt-3 content">
                            ...
                            <a href="mailto:support@Securedgainers.com"
                                class="text-primary">support@Securedgainers.com</a>
                        </div>
                    </div>
                </div>
                <!--end col-->
                ...
                <div class="pt-2 mt-4 col-md-4 mt-sm-0 pt-sm-0">
                    <div class="text-center border-0 card features feature-clean">
                        ...
                        <div class="mt-3 content">
                            ...
                            <p class="text-muted">BOWLING GREEN,NY1004</p>
                    ...
                    <div class="border-0 rounded shadow card">
                        <div class="py-5 card-body">
                            ...
                            <div class="mt-4 custom-form">
                                <div id="message"></div>
                                <form method="post" action="https://Securedgainers.com/sendcontact">
                                    <input type="hidden" name="_token" value="E6FAL35ouGxXTIaS1hUckb9zG9Q7PYudaYrdW6NB">                                    <div class="row">
                                        <div class="col-md-6">
